...
window.onload = function() {
    let mountainSelectEl = document.getElementById("mountainSelect");
...
let populateDropdown = (selectEl, array) => {
...
let mountainInfo = mountainsArray.find((mountain) => mountain.name === selectedMountain);  
...
populateDropdown(mountainSelectEl, mountainsArray);
